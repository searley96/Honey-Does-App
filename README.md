...
The HoneyDoes App was createed by Fue Lee, Ia Vue, James Jacobsen, Sean Kimbrough, and Siv Earley. This mobile app was created for Melissa Weed at HoneyDoes LLC. It is intended for use by customers, cleaners, and admin of HoneyDoes, and contains different views for each of these roles. The main features within this app are user-friendly forms, which consolidate and organize vital clean information, and a chat that allows admin, cleaners, and clients to communicate with one another.  
